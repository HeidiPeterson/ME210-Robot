...
#define BLACK_THRESHOLD_HIGH   220  //placeholder value
...
void initializePins(){
  ...
  digitalWrite(directionPin2, directionOutput2); //initialize direction pin 2 to LOW
}

void readLineSensors(){
//Teensy reads value from phototransistor in OPB704WZ
  frontLineSensorLeft = analogRead(photoA7);
  frontLineSensorRight = analogRead(photoA5);
